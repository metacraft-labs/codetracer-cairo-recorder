// Minimal Starknet contract example. Records the entry point's
// storage reads/writes and the emitted event so the CodeTracer GUI
// can show storage diffs and event history alongside the source.
#[starknet::interface]
